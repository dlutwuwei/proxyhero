...
export function CertificateView() {
  ...
  return (
    <div className="overflow-auto p-4">
      ...
      {diag && (
        <section className="mb-4 max-w-xl rounded border border-[#333] bg-[#252526] p-4 text-sm">
      ...
      <div className="mb-4 max-w-xl rounded border border-[#333] bg-[#252526] p-4 text-sm">
      ...
      <div className="max-w-xl rounded border border-[#333] bg-[#252526] p-4 text-sm">
